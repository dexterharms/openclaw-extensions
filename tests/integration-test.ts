...
class IntegrationTester {
  ...
  constructor() {
    this.imapClient = new ImapClient(IMAP_CONFIG);
    this.smtpClient = new SmtpClient(SMTP_CONFIG);
  }
  ...
  async testListFolders(): Promise<boolean> {
  ...
  async testGetMessages(): Promise<boolean> {
  ...
  async testSendEmail(): Promise<boolean> {
    console.log('\n=== Testing Send Email ===');
    try {
